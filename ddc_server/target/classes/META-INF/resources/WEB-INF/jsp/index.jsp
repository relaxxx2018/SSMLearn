...
<head>
    ...
    <![endif]-->
    <title>懂点车后台管理系统</title>
    <meta name="keywords" content="懂点车后台管理系统">
    <meta name="description" content="懂点车后台管理系统">
</head>
<body>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A"><shiro:principal property="name"/> <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="/page/consulation" data-title="资讯管理" href="javascript:void(0)">资讯管理</a></li>
                    <li><a data-href="/page/picture" data-title="图片管理" href="javascript:void(0)">图片管理</a></li>
                    <li><a data-href="article_column.html" data-title="栏目管理" href="javascript:void(0)">栏目管理</a></li>
                    <li><a data-href="/page/chart2" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
        ...
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a data-href="/page/welcome" data-title="会员列表" href="javascript:;">会员列表</a></li>
                    <!--<li><a data-href="member-del.html" data-title="删除的会员" href="javascript:;">删除的会员</a></li>-->
                    <!--<li><a data-href="member-level.html" data-title="等级管理" href="javascript:;">等级管理</a></li>-->
                    <!--<li><a data-href="member-scoreoperation.html" data-title="积分管理" href="javascript:;">积分管理</a></li>-->
                    <li><a data-href="/page/record" data-title="浏览记录" href="javascript:void(0)">浏览记录</a>
                    </li>
        ...
        <dl id="menu-tongji">
            ...
            <dd>
                <ul>
                    <li><a data-href="/page/chart" data-title="折线图" href="javascript:void(0)">活跃用户城市统计</a></li>
                    <li><a data-href="/page/chart1" data-title="时间轴折线图" href="javascript:void(0)">浏览资讯数据统计</a></li>
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="/page/welcome">我的桌面</span>
                    <em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="/page/welcome"></iframe>
        </div>
    </div>
</section>
