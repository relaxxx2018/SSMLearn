...
<div class="page-container">
  ...
  <div class="mt-20">
    <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive" id="app">
      <thead>
      <tr class="text-c">
      ...
      <tr class="text-c" v-for="item in items">
        ...
        <td class="text-l"><u style="cursor:pointer" class="text-primary"
                              onClick="article_edit('查看','article-zhang.html','10001')" title="查看">{{item.title}}</u></td>
        <td>{{item.sort}}</td>
        <td>{{item.author}}</td>
